...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
   * | Shift|   Z  |   X  |   C  |   V  |   B  |Lower |Adjust|   N  |   M  |   ,  |   .  |   /  |Shift |
   * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
   * |   `  |   =  | Alt  | Cmd  |Space |Space |Lower |Enter |Space |Space | Cmd  |  \   |Bspace|Raise |
   * `-------------------------------------------------------------------------------------------------'
   */
  [_QWERTY] = LAYOUT( \
      ...
      KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,   LOWER,     ADJUST, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_LSFT, \
      KC_GRV,  KC_EQL, KC_RCMD, KC_LALT, KC_SPC,   KC_SPC, LOWER,    KC_ENT, KC_SPC,  KC_SPC,  KC_LALT, KC_BSLS, KC_BSPC, RAISE \
      ),
