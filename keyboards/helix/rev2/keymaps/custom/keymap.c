...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
   * |Lower |Caps  |Adjust|Eject | Cmd  |Space |Bspace|Enter |Space | Cmd  |   [  |   ]  |  \   |Raise |
   * `-------------------------------------------------------------------------------------------------'
   */
  [_QWERTY] = LAYOUT( \
      ...
      KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,   KC_LALT,  KC_RALT, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_GRV, \
      LOWER,   KC_CAPS, ADJUST,  KC_EJCT ,KC_LCMD, KC_SPC, KC_BSPC,  KC_ENT,  KC_SPC,  KC_RCMD, KC_LBRC, KC_RBRC, KC_BSLS, RAISE \
      ),
