...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
   * |   [  |   ]  | Alt  | Cmd  |Space |Space | Esc  |Enter |Space |Space | Cmd  |  \   |Bspace|Raise |
   * `-------------------------------------------------------------------------------------------------'
   */
  [_QWERTY] = LAYOUT( \
      ...
      KC_BSLS, KC_BSPC, KC_RCMD, KC_LALT, KC_SPC,  KC_SPC, KC_ESC,    KC_ENT, KC_SPC,  KC_SPC,  KC_LALT, KC_BSLS, KC_BSPC, RAISE \
      ),
  ...
  [_LOWER] = LAYOUT( \
      ...
      _______, _______, _______, _______, _______, _______,                   _______, KC_ESC,  _______, KC_LBRC, KC_RBRC, KC_BSLS, \
  ...
  [_RAISE] = LAYOUT( \
      ...
      _______, _______, _______, _______, _______, _______, KC_SPC,  KC_ENT,  _______, _______, _______, _______, KC_DOWN, _______ \
      ),
