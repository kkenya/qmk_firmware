...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
   * |   `  |Adjust| Alt  | Cmd  |Space |Space |Lower |Enter |Space |Space | Cmd  | Alt  |  \   |Raise |
   * `-------------------------------------------------------------------------------------------------'
   */
  [_QWERTY] = LAYOUT( \
      ...
      KC_GRV,  ADJUST,  KC_RCMD, KC_LALT, KC_SPC,  KC_SPC, LOWER,   KC_ENT,  KC_SPC,  KC_SPC,  KC_LALT, KC_RCMD, KC_BSLS, RAISE \
      ),
  ...
  /* Lower
   * ,-----------------------------------------.             ,-----------------------------------------.
<<<<<<< HEAD:keyboards/helix/rev2/keymaps/kkenya/keymap.c
   * |      |      |      |      |      |      |             |      |      |      |      |      |   =  |
   * |------+------+------+------+------+------|             |------+------+------+------+------+------|
   * |   `  |   1  |   2  |   3  |   4  |   5  |             |   6  |   7  |   8  |   9  |   0  |   ]  |
   * |------+------+------+------+------+------|             |------+------+------+------+------+------|
...
=======
   ...
   * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
   * |      |      |      |      |      |      |      |      |      |      |      | Home | End  |  \   |
>>>>>>> c616d4337510f9e5917b3e9e459480b0c5663d66:keyboards/helix/rev2/keymaps/custom/keymap.c
   * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
...
=======
      ...
      KC_TILD, KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC,                   _______, _______, _______, KC_LCBR, KC_RCBR, KC_RBRC, \
      _______, _______, _______, _______, _______, _______,                   _______, KC_ESC,  _______, KC_LBRC, KC_RBRC, KC_ENT, \
      _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_HOME, KC_END,  KC_BSLS, \
...
<<<<<<< HEAD:keyboards/helix/rev2/keymaps/kkenya/keymap.c
      ...
      _______, _______, KC_UP,   _______, _______, _______,                   _______, _______, _______, _______, KC_UP,   _______, \
...
=======
      ...
      _______, _______, _______, _______, _______, _______, KC_SPC,  KC_ENT,  _______, _______, KC_LEFT, KC_DOWN, KC_RGHT, _______ \
>>>>>>> c616d4337510f9e5917b3e9e459480b0c5663d66:keyboards/helix/rev2/keymaps/custom/keymap.c
      ),
